...
include "controllers/ProduccionControllerMP.php";
...
// Crear instancia del controller de producción
$produccionController = new ProduccionControllerMP($conexion);
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo $url_base; ?>secciones/materiaprima/produccion_mp.php">
                            <i class="fas fa-industry me-1"></i>Materiales Producción
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <div class="main-container">
        <div class="container-fluid">
            <div class="production-card">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 class="mb-1 text-success">
                            <i class="fas fa-industry me-2"></i>Materiales para Producción
                        </h4>
                        <p class="text-muted mb-0">Gestión de materiales para procesos de producción</p>
                    </div>
                    <div class="quick-actions">
                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalMateriaPrima" onclick="prepararModalNuevo()">
                ...
                <div class="form-section" id="panelBusqueda" style="display: none;">
                    <div class="card border-info mb-4">
                        <div class="card-header bg-info text-white">
                            <h5 class="mb-0">
                                <i class="fas fa-search me-2"></i>Buscar en Producción
                            </h5>
                        </div>
                        <div class="card-body">
                ...
                <!-- Listado de materiales en producción -->
                <div class="ultimas-cajas">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h6 class="text-secondary mb-0">
                            <i class="fas fa-list me-2"></i>Inventario de Materiales (Producción)
                        </h6>
                    ...
                    <?php if (!empty($datosPaginacion['registros'])): ?>
                        <!-- Tabla de materiales en producción -->
                                ...
                                <tbody>
                                    <?php foreach ($datosPaginacion['registros'] as $registro): ?>
                                        <tr class="materia-prima-row" data-id="<?php echo $registro['id']; ?>">
                                            <td><strong class="text-success">#<?php echo $registro['id']; ?></strong></td>
                                            <td>
                    ...
                    <?php else: ?>
                        <div class="text-center text-muted py-4">
                            ...
                            <?php if (!empty($filtros['buscar_descripcion']) || !empty($filtros['buscar_ncm']) || !empty($filtros['buscar_tipo'])): ?>
                                ...
                                <p>No hay materiales para producción que coincidan con los criterios de búsqueda.</p>
                                <a href="?" class="btn btn-primary">
                                    <i class="fas fa-times me-2"></i>Limpiar filtros
                                </a>
                            <?php else: ?>
                                <h5>No hay materiales para producción</h5>
                                <p>¡Comience agregando su primer material para producción!</p>
                                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalMateriaPrima" onclick="prepararModalNuevo()">
            ...
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title" id="modalMateriaPrimaLabel">
                        ...
                        <span id="tituloModal">Registrar Nueva Materia Prima para Producción</span>
                    </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="POST" action="" id="formMateriaPrima">
                    <div class="modal-body">
                        <input type="hidden" name="accion" id="accionFormulario" value="agregar_produccion">
                        <input type="hidden" name="id_editar_produccion" id="idEditar" value="">
    ...
    <form method="POST" action="" id="formEliminar" style="display: none;">
        ...
        <input type="hidden" name="id_finalizar" id="idEliminar" value="">
    </form>
    ...
    <script>
        ...
        function limpiarFormulario() {
            ...
            document.getElementById('accionFormulario').value = 'agregar_produccion';
            document.getElementById('idEditar').value = '';
            document.getElementById('tituloModal').textContent = 'Registrar Nueva Materia Prima para Producción';
        ...
        function editarMateriaPrima(registro) {
            ...
            document.getElementById('accionFormulario').value = 'editar_produccion';
            document.getElementById('idEditar').value = registro.id;
            document.getElementById('tituloModal').textContent = 'Editar Material en Producción #' + registro.id;
        ...
        // Eliminar materia prima (finalizar producción)
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="text-center">
                                    ...
                                    <h6>¿Está seguro de que desea eliminar este material de producción?</h6>
