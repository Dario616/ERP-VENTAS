...
<head>
    ...
    <title>AMERICA TNT - MATERIA PRIMA</title>
    ...
    <link rel="stylesheet" href="<?php echo $url_base; ?>secciones/materiaprima/utils/main.css">
</head>
            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="hero-title">
                        ...
                        Centro de Configuración de Materiales
                    </h1>
                    ...
                    <div class="dashboard-card">
                        ...
                        <div class="card-body">
                            <div class="quick-actions">
                                <a href="<?php echo $url_base; ?>secciones/materiaprima/materia_prima.php" class="quick-action-btn btn-primary">
                                    <i class="fas fa-boxes"></i>
                                ...
                                if (tieneRol(['1'])) {
                                ?>
                                    <a href="<?php echo $url_base; ?>secciones/materiaprima/recetas-materia-prima.php" class="quick-action-btn btn-info">
                                        <i class="fas fa-clipboard-list"></i>
                                        <span>Recetas Materia Prima</span>
                                    </a>
                                <?php
                                }
                                ?>
                                ...
                                <a href="<?php echo $url_base; ?>secciones/materiaprima/produccion.php" class="quick-action-btn btn-success">
                                    <i class="fas fa-cogs"></i>
                                    <span>Produccion de Materiales</span>
                                </a>
                            </div>
                        </div>
                    </div>
