...
<head>
    ...
    <title>AMERICA TNT - TIPOS DE TRANSPORTE</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo $url_base; ?>secciones/configuracion/tipos_transporte.php">
                            <i class="fas fa-route me-1"></i>Tipos de Transporte
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="hero-title">
                        ...
                        Gestión de Tipos de Transporte
                    </h1>
                    <p class="hero-subtitle">
                        Administrar modalidades de transporte para el sistema logístico America TNT
                    </p>
