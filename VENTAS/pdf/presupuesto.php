...
function generarPDFPresupuesto($id_presupuesto, $conexion)
{
    try {
        ...
        <head>
            ...
            <style>
                @page {
                    margin: 10mm; /* Pequeño margen para evitar cortes */
                    padding: 0;
                }
                body {
                ...
                /* ✅ NUEVO: Estilos para el sello de aprobación */
                .approval-stamp {
                    position: absolute;
                    top: -3mm;
                    left: -5mm;
        ...
        for ($pagina = 0; $pagina < $totalPaginas; $pagina++) {
            ...
            <div class="page-container">
                <!-- ✅ NUEVO: Sello de aprobación (solo se muestra si cumple condiciones) -->
            ...
            $html .= '
                ...
                <!-- Footer Section - Se muestra en todas las páginas -->
                <div class="footer">
