                ...
                <div class="info-section">
                    ...
                    <table class="info-table" cellpadding="1" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="info-value">' . ($cliente['email'] ?? 'Não disponível') . '</td>
                        </tr>
                        <tr>
                            <td class="info-label">Telefone:</td>
                            <td class="info-value">' . ($cliente['telefono'] ?? 'Não disponível') . '</td>
                        </tr>
                        <tr>
                       ...
                       <table class="additional-info-content" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="additional-info-left">
                                    ...
                                    <div class="info-item">
                                        <span class="label">Account with:</span>
                                        <span class="value">Citibank Na. New York</span>
                                    </div>
                                    <div class="info-item">
                                        <span class="label">Swift Code:</span>
                                        <span class="value">CITIUS33</span>
                                    </div>
                                    <div class="info-item">
                                    ...
                                    <div class="info-item">
                                        <span class="label">Codigo Swift:</span>
                                        <span class="value">BSUDPYPX</span>
                                    </div>
                                    <div class="info-item">
                                        <span class="label">Beneficiario Final:</span>
                                        <span class="value">8059024 (Cuenta Corriente en dólares)</span>
                                    </div>
                                    <div class="info-item">
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td width="35%" style="text-align: center; vertical-align: top;">
                            ...
                            <div style="font-size: 8pt; margin-top: 1mm; width: 70%; margin: 1mm auto 0 auto;">' . ($cliente['cnpj'] ?? 'No disponible') . '</div>
                        </td>
                        <td width="10%" style="text-align: center;"></td>
                        <td width="35%" style="text-align: center; vertical-align: top;">
                            <div style="border-bottom: 1px solid #000; height: 10mm; margin-bottom: 2mm; width: 70%; margin: 0 auto 2mm auto;"></div>
