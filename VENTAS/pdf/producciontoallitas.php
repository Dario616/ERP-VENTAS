...
try {
    ...
    if (!$orden) {
        header("Location: ../secciones/sectorPcp/produccion.php?error=Orden de producción de toallitas no encontrada");
        exit();
    }
    ...
    $pdf->MultiCell(63, 6, $orden['descripcion'], 1, 'C', 1, 0, $x, $y);
    ...
    header("Location: ../secciones/sectorPcp/produccion.php?error=" . urlencode("Error al generar el PDF de toallitas: " . $e->getMessage()));
    exit();
}
