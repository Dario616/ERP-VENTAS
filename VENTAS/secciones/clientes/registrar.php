...
if (!$controller->verificarPermisos('crear')) {
    header("Location: " . $url_base . "secciones/clientes/index.php?error=No tienes permisos para crear clientes");
    exit();
}
...
$breadcrumb_items = ['Configuracion', 'Clientes', 'Registrar Cliente'];
$item_urls = [
    ...
    <div class="container-fluid my-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo $url_base; ?>secciones/clientes/registrar.php" method="POST">
