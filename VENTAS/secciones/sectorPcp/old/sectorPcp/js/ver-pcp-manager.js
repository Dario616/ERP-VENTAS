class VerPcpManager {
  ...
  init() {
    ...
    setTimeout(() => {
      ...
      this.initImageGallery(); // ✅ AGREGAR ESTA LÍNEA
...
class ConfirmationSystem {
  ...
  initializeEventListeners() {
    ...
    // ✅ NUEVO: Interceptar envío de formulario de finalizar venta
  ...
  setupProduccionConfirmation(form) {
    ...
    document.getElementById("warningText").textContent =
      "Los productos serán enviados inmediatamente a la cola de producción.";
  ...
  // ✅ NUEVO MÉTODO: Configurar confirmación para finalizar venta
